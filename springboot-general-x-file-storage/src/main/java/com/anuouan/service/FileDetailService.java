package com.anuouan.service;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.lang.Dict;
import cn.hutool.core.text.StrBuilder;
import cn.hutool.core.util.StrUtil;
import com.anuouan.mapper.FileDetailMapper;
import com.anuouan.model.FileDetail;
...
public class FileDetailService extends ServiceImpl<FileDetailMapper, FileDetail> implements FileRecorder {
    ...
    public boolean save(FileInfo info) {
        ...
        StrBuilder sb = new StrBuilder().append(endPoint).append("/").append(bucketName).append("/").append(detail.getUrl());
        detail.setFullPath(sb.toString());
    ...
    public FileInfo getByUrl(String url) {
        ...
        return toFileInfo(getOne(new QueryWrapper<FileDetail>().eq(FileDetail.COL_URL, url).or().eq(FileDetail.FULL_PATH, url)));
    }
    ...
    public boolean delete(String url) {
        remove(new QueryWrapper<FileDetail>().eq(FileDetail.COL_URL, url).or().eq(FileDetail.FULL_PATH, url));
        return true;
    }
